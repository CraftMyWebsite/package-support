            ...
            <div class="card">
                <div class="card-header">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="captcha"><h6><?= LangManager::translate("support.settings.mail") ?></h6></label>
                    </div>
                </div>
                <div class="card-body">
                    <div>
                    ...
                    <div>
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="captcha"><h6><?= LangManager::translate("support.settings.senderMail") ?></h6></label>
                        </div>
                        <div class="form-group">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="captcha"><h6>Discord Webhook - <?= LangManager::translate("support.settings.newRequest") ?> :</h6></label>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="captcha"><h6>Discord Webhook - <?= LangManager::translate("support.settings.newResponses") ?> :</h6></label>
                    </div>
                    <div class="form-group">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label" for="captcha"><?= LangManager::translate("support.settings.captcha") ?></label>
                        </div>
                        <!--TODO : Gérer ceci :-->
